...
def run_truthchain(claim: str):
    ...
    # Blockchain cache removed - always run full verification
    console.print("[dim]Running full verification...[/dim]")
    ...
    # Blockchain submission removed
    logger.info("Verification complete - blockchain functionality removed")
